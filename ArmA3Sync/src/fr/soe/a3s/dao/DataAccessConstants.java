...
public interface DataAccessConstants {
	...
	String CONFIGURATION_FILE_PATH = INSTALLATION_PATH + "/resources/configuration/a3s.cfg";
	String PREFERENCES_FILE_PATH = INSTALLATION_PATH + "/resources/configuration/a3s.prefs";
