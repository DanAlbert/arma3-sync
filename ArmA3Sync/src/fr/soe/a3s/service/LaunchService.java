...
public class LaunchService {
    ...
    public void checkArmA3ExecutableLocation() throws LaunchException {
        ...
        String arma3ExePath = configuration.getLauncherOptions().getArma3ExePath();
    ...
    public void checkAllinArmALocation() throws LaunchException {
        ...
        String allInArmaPath = configurationDAO.getConfiguration().getAiaOptions()
                .getAllinArmaPath();
    ...
    public void launchArmA3WithSteam() throws LaunchException {
        ...
        /* Get steam.exe path */
        String steamLaunchPath = configurationDAO.getConfiguration().getLauncherOptions()
                .getSteamExePath();
    ...
    public void launchArmA3() {
        ...
        /* Get arma3.exe path */
        String arma3Path = configurationDAO.getConfiguration().getLauncherOptions()
                .getArma3ExePath();
    ...
    public List<String> getRunParameters() {
        ...
        if (configuration.getGameVersion().equals(GameVersions.ARMA3_AIA.getDescription())) {
            ...
            if (path != null && arma3ExePath != null) {
                ...
                allInArma = allInArma + "@A1A2ObjectMerge;@A2OAPondFix;" + parentArma3ExePath + ";"
    ...
    private void getSelectedAddonNames(TreeDirectory treeDirectory, Set<String> addonNames) {
