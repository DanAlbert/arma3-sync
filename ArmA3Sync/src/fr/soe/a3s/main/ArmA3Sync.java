...
public class ArmA3Sync implements DataAccessConstants {
    ...
    /**
     * This is the entry point for ArmA3Sync. ArmA3Sync is a free software and agree the GNU Global
    ...
    private static void setFoldersAndPermissions() {
        ...
        boolean configurationOK = Files.isWritable(FileSystems.getDefault().getPath(
                configurationFolder.getAbsolutePath()));
        //
        ...
        if (!profilesOK) {
            ...
            message = "Cannot write into directory: resources" + File.separator + "configuration.";
        }
        else if (!ftpOK) {
            message = "Cannot write into directory: resources" + File.separator + "ftp.";
        }
        else if (!tempOK) {
            message = "Cannot write into directory: resources" + File.separator + "temp.";
        }
    ...
    private static void applyLookAndFeel() {
        ...
        try {
            ...
            if (osName.contains("Windows")) {
                ...
                Font fontCheckBoxMenuItemA3S = new Font(fontCheckBoxMenuItem.getName(), Font.PLAIN,
                        11);
                javax.swing.UIManager.put("CheckBoxMenuItem.font", new FontUIResource(
                        fontCheckBoxMenuItemA3S));
                ...
                Font fontTextFieldA3S = new Font(fontTextField.getName(), fontTextField.getStyle(),
                        11);
            ...
            if (!lookAndFeel.equals(LookAndFeel.LAF_DEFAULT)) {
...

                {
                    ...
                    props.put("userTextFont", fontName + " " + Integer.toString(sytle) + " "
                            + Integer.toString(size));
                    props.put("subTextFont", fontName + " " + Integer.toString(sytle) + " "
                            + Integer.toString(size));
                    ...
                    sytle = font.getStyle();
                    size = font.getSize();
                    props.put("controlTextFont", fontName + " " + Integer.toString(sytle) + " "
                            + Integer.toString(size));
                    ...
                    sytle = font.getStyle();
                    size = font.getSize();
                    props.put("menuTextFont", fontName + " " + Integer.toString(sytle) + " "
                            + Integer.toString(size));
                }
