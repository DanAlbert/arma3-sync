...
public class SyncPanel extends JPanel implements UIConstants {
        ...
        centerPanel.setLayout(new BoxLayout(centerPanel, BoxLayout.Y_AXIS));
        {
            ...
            centerPanel.add(addonRepositoriesPanel);
            {
                ...
                containerPanel1.setBorder(BorderFactory.createTitledBorder(
                        BorderFactory.createEtchedBorder(), "Addons Repositories"));
                ...
                TableColumn col1 = tableRepositories.getColumnModel().getColumn(1);
                col1.setWidth(50);
                col1.setMaxWidth(50);
                TableColumn col2 = tableRepositories.getColumnModel().getColumn(2);
                col2.setWidth(100);
    ...
    public void init() {
        ...
        while (iter.hasNext()) {
            ...
            try {
                ServerInfoDTO serverInfoDTO = repositoryService.getServerInfo(name);
    ...
    private void buttonNewPerformed() {
        RepositoryEditPanel repositoryEditPanel = new RepositoryEditPanel(facade);
    ...
    private void buttonEditPerformed() {
        ...
        int index = tableRepositories.getSelectedRow();
        if (index == -1 || index > tableRepositories.getRowCount()) {
            JOptionPane.showMessageDialog(facade.getMainPanel(), "Please select a repository.",
    ...
    private void connectToRepository() {
        ...
        if (repositoryName != null) {
            ConnectionPanel connectionPanel = new ConnectionPanel(facade, repositoryName, null);
    ...
    private void buttonCheckEventPerformed() {
        ...
        if (index != -1 && !(index > listEvents.getVisibleRowCount())) {
            ...
            ConnectionPanel connectionPanel = new ConnectionPanel(facade, repositoryName, eventName);
            connectionPanel.setVisible(true);
            connectionPanel.init();
        }
    }
    ...
    class MyTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            else if (value.toString().equals(RepositoryStatus.OUTOFSYNC.getDescription())) {
                c.setForeground(Color.RED);
            }
            else {
