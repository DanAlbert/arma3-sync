...
public class LauncherOptionsPanel extends JPanel implements DocumentListener, UIConstants {
    ...
    private JButton buttonSelectArmAExe, buttonSelectSteamExe, buttonAutoRestartPreferences;

    private JComboBox comboBoxProfiles, comboBoxMaxMemory, comboBoxCpuCount, comboBoxExThreads,
            comboBoxMalloc;

    private JCheckBox checkBoxProfiles, checkBoxNoPause, checkBoxWindowMode,
            checkBoxShowScriptErrors, checkBoxMaxMemory, checkBoxCpuCount, checkBoxNoSplashScreen,
            checkBoxDefaultWorld, checkBoxNoLogs, checkBoxCheckSignatures, checkBoxExThreads,
            checkBoxEnableHT, checkBoxNoFilePatching, checkBoxAutoRestart, checkBoxMalloc;
    ...
    public LauncherOptionsPanel(Facade facade) {
        ...
        performancePanel.add(vBox);
        {
            ...
            ComboBoxModel maxMemoryModel = new DefaultComboBoxModel(new String[] { "",
        ...
        }
        {
            ...
            ComboBoxModel exThreadsModel = new DefaultComboBoxModel(new String[] { "", "0", "1",
                    "3", "5", "7" });
        ...
        additionalParametersTextArea.setFont(new Font("Tohama", Font.ITALIC, 11));
        ...
        scrollPaneAditionalParameters.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), "Additional Parameters"));
    ...
    private void checkBoxShowScriptErrorsPerformed() {
        configurationService.setCheckBoxShowScriptErrors(checkBoxShowScriptErrors.isSelected());
        updateRunParameters();
    }
    ...
    private void checkBoxNoFilePatchingPerformed() {
        configurationService.setCheckBoxNoFilePatching(checkBoxNoFilePatching.isSelected());
        updateRunParameters();
    }

    private void checkBoxWindowModePerformed() {
        configurationService.setCheckBoxWindowMode(checkBoxWindowMode.isSelected());
        updateRunParameters();
    }

    private void checkBoxCheckSignaturesPerformed() {
        configurationService.setCheckBoxCheckSignatures(checkBoxCheckSignatures.isSelected());
        updateRunParameters();
    }

    private void checkBoxAutoRestartPerformed() {
        configurationService.setCheckBoxAutoRestart(checkBoxAutoRestart.isSelected());
    }
    ...
    private void checkBoxNoSplashScreenPerformed() {
        configurationService.setNoSplashScreen(checkBoxNoSplashScreen.isSelected());
        updateRunParameters();
    }
    ...
    public void setAdditionalParameters() {
        ...
        String additionalParameters = additionalParametersTextArea.getText().trim();
        try {
    ...
    public void updateOptions() {
        ...
        LauncherOptionsDTO launcherOptionsDTO = configurationService.getLauncherOptions();
        ...
        if (launcherOptionsDTO.getCpuCountSelection() != 0) {
            comboBoxCpuCount.setSelectedItem(Integer.toString(launcherOptionsDTO
