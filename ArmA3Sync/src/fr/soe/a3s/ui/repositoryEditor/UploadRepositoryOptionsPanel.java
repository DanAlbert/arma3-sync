...
public class UploadRepositoryOptionsPanel extends JDialog implements
	...
	public void init(String repositoryName) {
		...
		try {
			...
			if (uploadProtocolDTO == null && protocol.equals(Protocol.FTP)) {
				...
				comboBoxProtocol.setSelectedItem(uploadProtocol
						.getDescription());
				textFieldHost.setText(uploadProtocol.getPrompt()
	...
	private void buttonOKPerformed() {
		...
		Protocol protocol = Protocol.getEnum((String) comboBoxProtocol
				.getSelectedItem());
