...
public class DownloadPanel extends JPanel implements UIConstants {
    ...
    private JButton buttonDownloadStart, buttonDownloadPause, buttonDownloadCancel;
    ...
    public DownloadPanel(Facade facade, RepositoryPanel repositoryPanel) {
        ...
        panel1.add(vBox, BorderLayout.NORTH);
        {
            ...
            labelCheckForAddonsStatus.setFont(new Font("Tohama", Font.ITALIC, 11));
        ...
        }
        {
            ...
            checkForAddonsProgressBarPanel.setPreferredSize(new Dimension(20, 20));
        ...
        vBox.add(Box.createVerticalStrut(20));
        {
            ...
            buttonAdvancedConfigurationPerformed = new JButton("Advanced configuration");
        ...
        arbre.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (!repositoryService.isDownloading(repositoryName)) {
                    totalFilesSize = 0;
                    compute(racine);
                    labelTotalFilesSizeValue.setText(UnitConverter.convertSize(totalFilesSize));
                }
        ...
        buttonAdvancedConfigurationPerformed.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
    ...
    private void hidePerformed() {
        ...
        addonsChecker = new AddonsChecker(facade, repositoryName, eventName, update, this);
        addonsChecker.start();
    }
    ...
    private void defaultFolderDestinationSelection() {
        ...
        Set<String> directories = configurationService.getAddonSearchDirectoryPaths();
    ...
    private void buttonDownloadStartPerformed() {
        ...
        if (totalFilesSelected == 0) {
            JOptionPane.showMessageDialog(facade.getMainPanel(), "There is no addon selected.",
        ...
        addonsDownloader = new AddonsDownloader(facade, repositoryName, racine, totalFilesSize,
                this);
    ...
    private void buttonAdvancedConfigurationPerformed() {
        ...
        if (racine == null) {
            JOptionPane.showMessageDialog(facade.getMainPanel(), "Please check for addons first.",
                    "Advanced configuration", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    public void updateAddons(SyncTreeDirectoryDTO syncTreeDirectoryDTO) {
        ...
        compute(racine);
        labelTotalFilesSizeValue.setText(UnitConverter.convertSize(totalFilesSize));
        labelTotalFilesUpdatedValue.setText(Integer.toString(totalFilesUpdated));
        labeltTotalFilesDeletedValue.setText(Integer.toString(totalFilesDeleted));
        addonSyncTreeModel = new AddonSyncTreeModel(racine);
        arbre.setModel(addonSyncTreeModel);
