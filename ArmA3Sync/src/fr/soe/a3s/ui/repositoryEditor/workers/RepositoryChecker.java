...
public class RepositoryChecker extends Thread implements DataAccessConstants {
    ...
    public void run() {
        ...
        try {
            ...
            connexionService.getConnexionDAO().addObserverCheck(new ObserverCheck() {
            ...
            this.errors = connexionService.checkRepositoryContent(repositoryName);
            ...
            if (!canceled) {
                ...
                if (errors.isEmpty()) {
                    ...
                    ErrorsListDialog dialog = new ErrorsListDialog(facade, "Check repository",
            ...
            if (!canceled) {
                e.printStackTrace();
                if (e instanceof RepositoryException || e instanceof RemoteRepositoryException) {
                    JOptionPane.showMessageDialog(facade.getMainPanel(), e.getMessage(),
                            "Check repository synchronization", JOptionPane.ERROR_MESSAGE);
                }
                    ...
                    UnexpectedErrorDialog dialog = new UnexpectedErrorDialog(facade,
                            "Check repository synchronization", e, repositoryName);
                    dialog.show();
                }
            }
        }
    ...
    private void initAdminPanelForEndCheck() {
        ...
        this.adminPanel.getCheckErrorLabelValue().setText("0");
        this.adminPanel.getCheckErrorLabelValue().setForeground(new Color(45, 125, 45));
        this.adminPanel.getCheckErrorLabelValue().setFont(new Font("Tohama", Font.ITALIC, 11));
