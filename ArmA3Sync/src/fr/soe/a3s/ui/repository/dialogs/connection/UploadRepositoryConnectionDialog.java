...
public class UploadRepositoryConnectionDialog extends AbstractConnectionDialog {
    ...
    protected void buttonOKPerformed() {
        ...
        ProtocolType protocolType = ProtocolType.getEnum((String) comboBoxProtocolModel
                .getSelectedItem());
        ...
        try {
            repositoryService.setRepositoryUploadProtocole(repositoryName, url, port, login,
                    password, protocolType, "0", "0");
            ProtocolDTO proxyProtocolDTO = proxyConfigurationDialog.getProxyProtocolDTO();
            repositoryService.setProxyProtocol(repositoryName, proxyProtocolDTO);
