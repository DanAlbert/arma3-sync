...
public class FirstPageACRE2InstallerPanel extends WizardPanel {
	...
	public FirstPageACRE2InstallerPanel(Facade facade) {
		...
		this.facade.setFirstPageACRE2InstallerPanel(this);
		{
	...
	private void buttonSelectTS3InstallationDirectoryPerformed() {
		...
		int returnVal = fc.showOpenDialog(FirstPageACRE2InstallerPanel.this);
	...
	public void buttonFistPerformed() {
		...
		SecondPageACRE2InstallerPanel secondPageInstallerPanel = new SecondPageACRE2InstallerPanel(
