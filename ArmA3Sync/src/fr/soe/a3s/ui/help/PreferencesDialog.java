        ...
        }
        {
            ...
            }
            {
                String[] tab = new String[] { LookAndFeel.LAF_DEFAULT.getName(),
                        LookAndFeel.LAF_ALUMINIUM.getName(), LookAndFeel.LAF_GRAPHITE.getName(),
                        LookAndFeel.LAF_HIFI.getName(), LookAndFeel.LAF_NOIRE.getName() };
            ...
            }
            {
                String[] tab = new String[] { IconResize.NONE.getDescription(),
                        IconResize.SIZE1.getDescription(), IconResize.SIZE2.getDescription(),
                        IconResize.SIZE3.getDescription(), IconResize.SIZE4.getDescription(),
